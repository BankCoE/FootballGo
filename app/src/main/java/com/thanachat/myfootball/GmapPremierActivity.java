...
public class GmapPremierActivity extends FragmentActivity {

    public DatabaseReference myRef;
    public DatabaseReference comment;
    public DatabaseReference presamment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gmap_premier);
        ...
        presamment = comment.child("premiersam");

        //firebase change
        presamment.addChildEventListener(new ChildEventListener() {
            @Override
...
//                list.add(value);
        ...
        cmt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(GmapPremierActivity.this);
                ...
                builder.setPositiveButton("ตกลง", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        cmtkey = presamment.push().getKey();
                        presamment.child(cmtkey).setValue(discmt);
                    }
                });
